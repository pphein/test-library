<?php 
    ...
    $borrowedBooks = mysqli_query($conn, "SELECT * FROM `order_items` where user_id = $user_id");
    $borrowedBookCount = mysqli_num_rows($borrowedBooks);
?>
...
<body>
    ...
    <div class="header">
        ...
        <div class="info">
            ...
            <br>
            <b class="limit">
                <?php if ($cart+$borrowbook >= 3 || $borrowedBookCount >= 3) {
 						echo "Limited";
 					} 
				?>
            </b>
            ...
            <?php while($row = mysqli_fetch_assoc($books)): ?>
                <li>
                    <div class="info">
                        ...
                        <b class="state">
                            ...
                            <?php elseif($row_id == $tmp['tmp_book_id']): ?>
                                Chosen
                            <?php elseif($cart >= 3 || $borrowedBookCount >= 3): ?>
                                You're Limited
                            <?php else: ?>
                    ...
                    <div class="words">
                        ...
                        <a href="admin/books/<?php if($row['book']){echo $row['book'];}else{echo "a.pdf";} ?>">
                            <i>read more</i>
                        </a>
                    </div>
